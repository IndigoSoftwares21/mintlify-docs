...
api: "GET https://api.sabivendor.com/api/v1/hub/shop/{shopId}"
---
...
```json 200 OK
{
  ...
  "data": {
    ...
    "logoImage": "https://cdn.sabivendor.com/logos/shoes.png",
    "bannerImage": "https://cdn.sabivendor.com/banners/shoes.png"
  }
}
```
