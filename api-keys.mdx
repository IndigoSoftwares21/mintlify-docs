...
All requests to the Sabi Vendor API are authenticated using API keys. Sabi Vendor uses a **dual-key security model** to protect your store's resources while allowing browser-side client requests.
...
<Tabs>
  ...
  <Tab title="JavaScript">
    ```javascript
    fetch('https://api.sabivendor.com/api/v1/storefront/shop/YOUR_SHOP_ID/products', {
      method: 'GET',
      headers: {
        'X-Shop-API-Key': 'pk_live_abc123...'
      }
  ...
  <Tab title="Axios">
    ...
    axios.get('https://api.sabivendor.com/api/v1/storefront/shop/YOUR_SHOP_ID/products', {
      headers: {
        'X-Shop-API-Key': 'pk_live_abc123...'
      }
    })
  ...
  <Tab title="PHP">
    ```php
    <?php
    $ch = curl_init('https://api.sabivendor.com/api/v1/storefront/shop/YOUR_SHOP_ID/products');
  ...
  <Tab title="Python">
    ...
    url = "https://api.sabivendor.com/api/v1/storefront/shop/YOUR_SHOP_ID/products"
    headers = {
        "X-Shop-API-Key": "pk_live_abc123..."
    }
